		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "M Table",
									"targetURL": "#mtablemtable-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"mtablemtable-display": {
								"semanticObject": "mtablemtable",
								"action": "display",
								"description": "M_Table",
								"title": "M Table",
								"signature": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=mtable.mtable",
									"url": sap.ui.require.toUrl("mtable/mtable")
								}
							}
						}
					}
